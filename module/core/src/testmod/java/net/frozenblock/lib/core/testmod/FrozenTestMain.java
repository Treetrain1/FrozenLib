package net.frozenblock.lib.core.testmod;

import net.fabricmc.api.ModInitializer;
import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.frozenblock.lib.core.replacements_and_lists.BlockScheduledTicks;
import net.frozenblock.lib.core.item.Camera;
import net.frozenblock.lib.core.item.LootTableWhacker;
import net.minecraft.core.Registry;
import net.minecraft.world.level.block.Blocks;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import static net.frozenblock.lib.core.FrozenMain.id;
