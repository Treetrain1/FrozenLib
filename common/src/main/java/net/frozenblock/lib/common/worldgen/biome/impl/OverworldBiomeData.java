package net.frozenblock.lib.common.worldgen.biome.impl;
...
public final class OverworldBiomeData {
    ...
    public static Climate.ParameterList<Holder<Biome>> withModdedBiomeEntries(Climate.ParameterList<Holder<Biome>> entries, Registry<Biome> biomeRegistry) {
