...
package org.quiltmc.qsl.frozenblock.common.misc.datafixerupper.api;
...
import org.quiltmc.qsl.frozenblock.common.misc.datafixerupper.impl.QuiltDataFixesInternals;
...
public final class QuiltDataFixes {
     ...
     * @param dataFixer      the data fixer
     */
    public static void registerFixer(@NotNull Mod mod,
                                     @Range(from = 0, to = Integer.MAX_VALUE) int currentVersion,
                                     @NotNull DataFixer dataFixer) {
     ...
     */
    public static void buildAndRegisterFixer(@NotNull Mod mod,
                                             @NotNull QuiltDataFixerBuilder dataFixerBuilder) {
        requireNonNull(mod, "mod cannot be null");
        requireNonNull(dataFixerBuilder, "data fixer builder cannot be null");

        registerFixer(mod.getModId(), dataFixerBuilder.getDataVersion(),
     ...
     * Builds and registers a new data fixer.
     *
     * @param modId              the mod container
     * @param dataFixerBuilder the data fixer builder
     */
    public static void buildAndRegisterFixer(@NotNull String modId,
                                             @NotNull QuiltDataFixerBuilder dataFixerBuilder) {
        requireNonNull(modId, "mod cannot be null");
        requireNonNull(dataFixerBuilder, "data fixer builder cannot be null");

        registerFixer(modId, dataFixerBuilder.getDataVersion(),
                dataFixerBuilder.build(Util::bootstrapExecutor));
    }
